...
while True:
    try:
        ...
        print(
            str(LS.parseIntOrReturn(a)) + "x " + LS.getSign(b) +
            str(LS.parseIntOrReturn(b)) + " = 0")
        ...
        print(
            str(QS.parseIntOrReturn(a)) + "x^ " + QS.getSign(b) +
            str(QS.parseIntOrReturn(b)) + "x " + QS.getSign(c) +
            str(QS.parseIntOrReturn(c)) + " = 0")
